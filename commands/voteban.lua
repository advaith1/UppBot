...
function main(message, args)
  ...
  for _, member in pairs(members) do
    ...
    if member:hasRole( message.guild:getRole("name", "Clickers")) == true then
      message.channel:sendMessage("You can not voteban Clickers!")
      break
    elseif member:hasRole( message.guild:getRole("name", "Staff")) == true then
      message.channel:sendMessage("You can not voteban Staff!")
      break
    elseif member:hasRole( message.guild:getRole("name", "Bots")) == true then
      message.channel:sendMessage("You can not voteban Bots!")
      break
    end
    -- Starting main
