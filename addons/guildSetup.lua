...
function gSetup.main(pack)
  ...
  database[guild.id] = database[guild.id] or {name=guild.name, addons={_config={}}, commands={config={addon="_config", name="main"}}, new=true}
  database[guild.id].addons = database[guild.id].addons or {_config={}}
  database[guild.id].commands = database[guild.id].commands or {config={addon="_config", name="main"}}
